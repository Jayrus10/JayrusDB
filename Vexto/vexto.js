...
function renderAll(){ 
    ...
    if(versionEl) versionEl.textContent = 'v' + APP_VERSION + ' beta'
    
    renderDashboard(); renderProducts(); renderDiscounts(); renderCustomers(); renderPurchases(); renderSales(); renderReports(); renderSettings() }
...
function printDailyReport(){
    ...
    printWindow.document.write(`
        ...
        <body>
            ...
            <div style="text-align: center; margin-top: 20px; padding-top: 10px; border-top: 1px solid #27272a; color: #71717a; font-size: 0.75rem;">
                Generado con Vexto v${APP_VERSION}
            </div>
